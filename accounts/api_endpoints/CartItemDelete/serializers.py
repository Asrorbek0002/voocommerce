...
from accounts.models import CartItem, User,Cart
...
class CartitemDeleteSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        def update(self, validated_data):
            ...
            return CartItem.objects.delete(cart = cart, product = validated_data["product"], quantity = validated_data["quantity"])
